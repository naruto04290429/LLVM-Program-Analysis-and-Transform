...
define i32 @polynomial(i32 %y) #0 {
  ...
  %5 = call i32 @pow32(i32 %4)
  store i32 %5, i32* %p3, align 4
  %load_GV1 = load i32* @GV3, align 4
...
define i32 @main() #0 {
  ...
  %3 = call i32 @polynomial4(i32 %2)
  store i32 %3, i32* %p, align 4
  %load_GV = load i32* @GV5, align 4
...
; Function Attrs: noreturn nounwind uwtable
define internal i32 @pow32(i32 %x) #2 {
  %1 = alloca i32, align 4
  store i32 %x, i32* %1, align 4
  %2 = load i32* %1, align 4
  %3 = load i32* %1, align 4
  ...
  %5 = load i32* %1, align 4
  %6 = mul nsw i32 %4, %5
  store i32 %6, i32* @GV3, align 4
  call void @pop_direct_branch()
  ret i32 %6
}

; Function Attrs: noreturn nounwind uwtable
define internal i32 @polynomial4(i32 %y) #2 {
  %1 = alloca i32, align 4
  %p2 = alloca i32, align 4
  %p3 = alloca i32, align 4
  store i32 %y, i32* %1, align 4
  %2 = load i32* %1, align 4
  %3 = call i32 @pow217(i32 %2)
  store i32 %3, i32* %p2, align 4
  %load_GV = load i32* @GV, align 4
  store i32 %load_GV, i32* %p2, align 4
  %4 = load i32* %1, align 4
  %5 = call i32 @pow328(i32 %4)
  store i32 %5, i32* %p3, align 4
  %load_GV1 = load i32* @GV3, align 4
  store i32 %load_GV1, i32* %p3, align 4
  %6 = load i32* %p3, align 4
  ...
  %12 = add nsw i32 %9, %11
  %13 = add nsw i32 %12, 1
  store i32 %13, i32* @GV5, align 4
  call void @pop_direct_branch()
  ret i32 %13
}

; Function Attrs: noreturn nounwind uwtable
define internal void @print_int6(i32 %x) #2 {
  %1 = alloca i32, align 4
  store i32 %x, i32* %1, align 4
  %2 = load i32* %1, align 4
  %3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str1, i32 0, i32 0), i32 %2)
...
; Function Attrs: noreturn nounwind uwtable
define internal i32 @pow217(i32 %x) #2 {
  %1 = alloca i32, align 4
  store i32 %x, i32* %1, align 4
  %2 = load i32* %1, align 4
  %3 = load i32* %1, align 4
...
; Function Attrs: noreturn nounwind uwtable
define internal i32 @pow328(i32 %x) #2 {
  %1 = alloca i32, align 4
  store i32 %x, i32* %1, align 4
  %2 = load i32* %1, align 4
  %3 = load i32* %1, align 4
